/* From https://github.com/asutherland/d3-threeD/blob/master/lib/d3-threeD.js
 * ...Which might be useful in the future 
 * Ref: http://www.smartjava.org/content/render-geographic-information-3d-threejs-and-d3js 
 */
...
function applySVGTransform(obj, tstr) {
  ...
  switch (cmd) {
    case 'translate':
      obj.position.x = Math.floor(eatNum());
      obj.position.y = Math.floor(eatNum());
...
exports.applySVGTransform = applySVGTransform;
